...
@interface SRVProcessorUsageRecord ()

@property (assign, nonatomic, readwrite) NSInteger  processorId;
@property (assign, nonatomic, readwrite) UInt64     userTime;
@property (assign, nonatomic, readwrite) UInt64     niceTime;
@property (assign, nonatomic, readwrite) UInt64     systemTime;
@property (assign, nonatomic, readwrite) UInt64     idleTime;
@property (assign, nonatomic, readwrite) UInt64     usedTime;
